...
## Corpus Check
- 55 files · ~4,585,329 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 257 nodes · 349 edges · 26 communities (19 shown, 7 thin omitted)
...
Cohesion: 0.11
Nodes (14): ContactCard(), ContactCardProps, CTASectionProps, DonationModal(), Icon(), IconProps, paths, SocialIcon() (+6 more)
...
Cohesion: 0.16
Nodes (13): App(), Navbar(), withCaret, ScrollToTop(), DonationContext, DonationContextType, DonationProvider(), useDonation() (+5 more)
...
- **Why does `useDonation()` connect `App Shell & Donation Context` to `Decorative & Hero Section Components`, `Card Components (Initiative/Stat/Story)`, `Dev Tooling Dependencies`, `Stories Page Data`, `Gallery.tsx`, `Initiatives.tsx`?**
...
- **Why does `site` connect `Decorative & Hero Section Components` to `Contact, CTA & Donation UI`, `App Shell & Donation Context`?**
