...
## Corpus Check
- 70 files · ~7,546,891 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 329 nodes · 449 edges · 32 communities (18 shown, 14 thin omitted)
...
Cohesion: 0.27
Nodes (8): faqItems, GetInvolvedIcon, helpOptions, partnershipOptions, processSteps, volunteerBenefits, cardThemes, iconMap

### Community 1 - "Decorative & Hero Section Components"
Cohesion: 0.10
Nodes (15): ContactCardProps, CTASectionProps, Icon(), IconProps, paths, SocialIcon(), SocialIconProps, contactMethods (+7 more)
...
Cohesion: 0.11
Nodes (18): App(), DonationModal(), DonationContext, DonationContextType, DonationProvider(), useDonation(), Initiative, initiatives (+10 more)

### Community 10 - "Stories Page Data"
Cohesion: 0.11
Nodes (16): BaseProps, ButtonAsButton, ButtonAsLink, ButtonProps, Variant, variantClass, beforeAfter, changeStories (+8 more)
...
## Knowledge Gaps
- **152 isolated node(s):** `$schema`, `plugins`, `react/rules-of-hooks`, `react/only-export-components`, `name` (+147 more)
